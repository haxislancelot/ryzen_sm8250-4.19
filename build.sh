...
TC_DIR="$(pwd)/tc/clang"
DEFCONFIG="vendor/kona-not_defconfig vendor/samsung/kona-sec-not.config vendor/samsung/$DEVICE.config vendor/not/droidspace.config vendor/not/full_lto.config vendor/not/no_werror.config"
